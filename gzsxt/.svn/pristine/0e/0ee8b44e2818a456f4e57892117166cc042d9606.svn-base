...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" action="user.action">
							<input type="hidden" name="cmd" value="roleAdd" />
							<div class="form-group">
								<label class="col-sm-3 control-label">提示信息：</label>
								<div class="col-sm-6">
									<span id="inputError" style="height:30px;line-height:30px;color:red;" >请输入添加的角色</span>
								</div>
							</div>						
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea name="introduce" id="introduce" style="width:375px;height:50px;"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">备注信息：</label>
								<div class="col-sm-6">
									<textarea name="remarks" id="remarks" style="width:375px;height:50px;"></textarea>
								</div>
							</div>
							<div class="form-group">
	...
	<script src="js/user/roleAdd.js"></script>
</body>
</html>