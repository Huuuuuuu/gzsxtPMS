	...
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
						...
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								...
								class="dropdown-toggle" href="#"> <span class="clear">
									<span class="block m-t-xs"><strong class="font-bold"><c:out value="${sessionScope.user.t_username}"></c:out></strong></span>
									<span class="text-muted text-xs block">个人空间<b
										class="caret"></b></span>
							</span>
							</a>
							<ul class="dropdown-menu animated fadeInRight m-t-xs">
								...
								<li class="divider"></li>
								<li><a href="user.action?cmd=loginout">安全退出</a></li>
							</ul>
						</div>
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="user.action?cmd=roleList"
								data-index="0">角色管理</a></li>
							<li><a class="J_menuItem" href="user.action?cmd=deptList">组织结构</a></li>
							<li><a class="J_menuItem" href="index_v3.html">员工管理</a></li>
							<li><a class="J_menuItem" href="index_v4.html">公告管理</a></li>
							<li><a class="J_menuItem" href="index_v4.html">个人信息</a></li>
							<li><a class="J_menuItem" href="index_v4.html">基础信息</a></li>
							<li><a class="J_menuItem" href="index_v4.html">数据字典</a></li>
						</ul></li>
						
					<li><a href="#"> <i class="fa fa-area-chart"></i> <span
							class="nav-label">销售管理</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="spservlet?cmd=salplanlist">销售计划</a>
							</li>
							<li><a class="J_menuItem" href="#">销售预测</a></li>
							<li><a class="J_menuItem" href="#">销售绩效</a>
							</li>
							<li><a class="J_menuItem" href="#">机会管理</a>
							</li>
							<li><a class="J_menuItem" href="#">联系人管理</a>
							</li>
							<li><a class="J_menuItem" href="#">竞争管理</a>
							</li>
							<li><a class="J_menuItem" href="#">销售分析</a>
							</li>
						</ul></li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="user.action?cmd=loginout" class="roll-nav roll-right J_tabExit"><i
			...
			<div class="footer">
				<div class="pull-right">
					&copy; 2016 <a href="" target="_blank">Cloud</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
						...
						<div>
							...
							<div class="sidebar-message">
								<a href="#">
									...
									<div class="media-body">
										...
										Cloud客户关系管理系统<br> <small class="text-muted">今天
											4:21</small>
									</div>
								</a>
							</div>
							<div class="sidebar-message">
								<a href="#">
									...
									<div class="media-body">
										Cloud客户关系管理系统 <br> <small class="text-muted">昨天
											2:45</small>
									</div>
								</a>
							</div>
		...
		<div class="small-chat-box fadeInRight animated">
			...
			<div class="content">
				...
				<div class="right">
					...
					<div class="chat-message">Cloud客户关系管理系统</div>
				</div>
				<div class="left">
					<div class="author-name">
						Beau-zihan <small class="chat-date"> 08:45 </small>
					...
					<div class="chat-message active">
						1.Cloud客户关系管理系统 <br> 2.Cloud客户关系管理系统 <br>
						3.Cloud客户关系管理系统
